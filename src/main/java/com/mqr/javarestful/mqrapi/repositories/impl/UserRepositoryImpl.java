package com.mqr.javarestful.mqrapi.repositories.impl;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SALT_MQR = "HqWuK6/Ng6sg9gQzbLrgb.";
    private static final Integer COST_MQR = 12;
